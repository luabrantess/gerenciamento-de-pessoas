...
<div class="modal ">
    <div class="modal-box max-w-5xl">
        <div class="info p-4 m-2  bg-gray-100 rounded-xl my-auto grid grid-cols-3">
            <div class="text-center flex justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-[80%] h-[80%]">
            ...
            <div class="my-auto mx-auto ">
                ...
                <h1 class="text-xl text-center font-medium">Dados pessoais</h1>
        ...
        <div class="grid grid-cols-2">
            ...
            <div class="p-4 m-2  bg-gray-100 rounded-xl">

                <h1 class="text-xl text-center font-medium">Fips assinadas</h1>
    
                <div class="mt-2 grid gap-1 text-center space-y-2 rounded-xl bg-white mt-2 p-2">
            ...
            <div class="p-4 m-2  bg-gray-100 rounded-xl">
                <h1 class="text-xl text-center font-medium">Dados universitários</h1>
                <div class=" rounded-xl bg-white mt-2 p-2">
