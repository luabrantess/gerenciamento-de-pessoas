        ...
        <div class="flex gap-5 mx-auto p-2 rounded-lg">
            ...
            <div class='grid w-full gap-3'>
                ...
                <div>
                    ...
                    <input placeholder="Data de nascimento" name="nascimento" max="2005-12-31" type="date" class="bg-gray-50 outline-0 rounded shadow p-2 {{ $errors->has('nascimento') ?  'input input-bordered input-error' : '' }}" />
                </div>
                <div>
            ...
            <div class="grid w-full">
                ...
                <input placeholder="Data inicial do contrato" type="date" name="inicio_contrato" class="bg-gray-50 outline-0 rounded shadow p-2 {{ $errors->has('inicio_contrato') ?  'input input-bordered input-error' : '' }}" />

                <label class="font-medium">Data final do contrato</label>
                <input placeholder="Data final do contrato" type="date" name="fim_contrato" class="bg-gray-50 outline-0 rounded shadow p-2 {{ $errors->has('fim_contrato') ?  'input input-bordered input-error' : '' }}" />
